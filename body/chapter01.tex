...
这是上海交通大学研究生学位学位论文~\LaTeX~模板，当前版本是~\version。
这是上海交大非官方出品的的~\LaTeX~研究生论文模板，是大家根据研究生院学位论文格式要求制作出的模板。
...
最近，又有同学提出希望能制作出交大研究生学位论文模板。
我参考了教务处对研究生学位论文格式的要求，在``博士学位论文~\LaTeX~模板''的基础上，制作了这个``研究生学位论文~\LaTeX~模板''。
...
欢迎大家使用交大研究生学位论文~\LaTeX~模板，有任何问题或者建议请到~TeX\_LaTeX~版发贴讨论。
...
参考文献列表是``生成''的，也不作为一个单独的文件。另外，学校的研究生研究生学位论文模板中，也没有要求加入个人建立，所以我没有在~diss.tex~中引入resume.tex。
...
我习惯把v0.2a使用dvipdfmx编译的研究生学位论文模板称为``CJK-\LaTeX{}模板''，而这个使用\XeTeX{}引擎(xelatex程序)处理的模板则被称为``\XeTeX/\LaTeX{}模板''。
...
关于页眉页脚。奇数页页眉为：左边``上海交通大学研究生学位论文''，右边：``章节名''；偶数页页眉为：左边``上海交通大学研究生学位论文''，右边：``论文题目''。每一章的内容按照排书的习惯，均从奇数页开始。
